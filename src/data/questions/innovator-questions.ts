...
export const INNOVATOR_QUESTIONS: AssessmentQuestion[] = [
  ...
  },
  {
    id: 'data-i-2',
    dimension: 'dataGovernance',
    text: 'How does your organization maintain and audit records of data subject consent and rights requests for personal data used in AI processing?',
    helpText: 'Data subject rights management for AI use cases spans consent records and withdrawal (GDPR/UK GDPR), opt-out and deletion rights (CCPA/CPRA), and equivalent obligations in other jurisdictions. Repurposing data for AI training without valid consent, or failing to honor deletion requests, is a top enforcement risk across all major privacy regimes.',
    type: 'radio',
    options: [
      { label: 'Automated system maintains audit trails by data subject, purpose, and AI use case — covering consent, opt-outs, and deletion requests; regularly audited for validity and coverage', value: 0, riskLevel: 'low' },
      { label: 'Records maintained and periodically reviewed, with AI processing purposes documented in consent and rights frameworks', value: 25, riskLevel: 'medium' },
      { label: 'Consent and opt-outs obtained for primary data collection but AI-specific processing purposes may not be explicitly captured', value: 50, riskLevel: 'high' },
      { label: 'Consent and rights management handled by legal team but AI processing purposes are not separately tracked or audited', value: 75, riskLevel: 'high' },
      { label: 'No audit trail exists for data subject consent or rights requests related to AI use cases', value: 100, riskLevel: 'critical' },
    ],
    weight: 1.4,
    jurisdictions: ['eu', 'uk', 'us'],
  },
  ...
  },
  {
    ...
    dimension: 'aiSpecificRisks',
    jurisdictions: ['eu'],
    text: 'How thoroughly has your organization classified its AI systems against EU AI Act Annex III high-risk categories?',
    helpText: 'Annex III defines high-risk AI use cases including employment screening, credit scoring, critical infrastructure management, education, law enforcement, and migration decisions. Classification determines your compliance obligations.',
    type: 'radio',
    options: [
      { label: 'Formal Annex III classification review completed for all AI systems, documented per system, assigned to a responsible owner, and integrated into AI procurement and development approval gates', value: 0, riskLevel: 'low' },
      { label: 'Annex III classification completed for all production AI systems with documentation and assigned owners, reviewed on a defined cadence', value: 25, riskLevel: 'medium' },
      { label: 'Classification completed for known high-risk systems but not systematically applied across all AI in use', value: 50, riskLevel: 'high' },
      { label: 'Classification reviewed informally — not documented or consistently applied', value: 75, riskLevel: 'high' },
      { label: 'No formal classification review conducted against EU AI Act Annex III categories', value: 100, riskLevel: 'critical' },
    ],
    weight: 1.3,
  },
  {
    ...
    dimension: 'aiSpecificRisks',
    jurisdictions: ['eu'],
    text: 'For AI systems classified as high-risk under the EU AI Act, how far advanced is your conformity assessment process?',
    helpText: 'Conformity assessment for high-risk AI requires documented risk management, data governance, technical robustness, transparency, human oversight, accuracy, and cybersecurity measures. Third-party assessment may be required for certain categories.',
    type: 'radio',
    options: [
      { label: 'Conformity assessments completed and documented for all high-risk AI systems, reviewed on a defined schedule, and maintained audit-ready', value: 0, riskLevel: 'low' },
      { label: 'Conformity assessments completed for primary high-risk systems with a roadmap to cover remaining systems', value: 25, riskLevel: 'medium' },
      { label: 'Conformity assessment initiated for some high-risk systems — not yet complete or consistent across all systems', value: 50, riskLevel: 'high' },
      { label: 'Conformity assessment requirements understood but process not yet initiated', value: 75, riskLevel: 'high' },
      { label: 'No conformity assessments underway despite operating systems that likely qualify as high-risk', value: 100, riskLevel: 'critical' },
    ],
    weight: 1.4,
  },
  {
    ...
    dimension: 'aiSpecificRisks',
    jurisdictions: ['eu'],
    text: 'Are human oversight, override authority, and escalation procedures for high-risk AI systems formally documented and operationally enforced?',
    helpText: 'EU AI Act Article 14 requires that high-risk AI systems allow human oversight with the ability to intervene, override, or halt the system. This must be operationally real, not just documented in policy.',
    type: 'radio',
    options: [
      { label: 'Human oversight procedures are formally documented per high-risk system, technically enforced in the workflow, tested for effectiveness, and reviewed by the AI governance body annually', value: 0, riskLevel: 'low' },
      { label: 'Oversight procedures are documented and operationally implemented for high-risk systems, with defined override and escalation paths', value: 25, riskLevel: 'medium' },
      { label: 'Oversight procedures documented but not consistently enforced in operational workflows', value: 50, riskLevel: 'high' },
      { label: 'Human oversight expected but not formally documented or technically enforced', value: 75, riskLevel: 'high' },
      { label: 'No documented human oversight or escalation procedures for high-risk AI systems', value: 100, riskLevel: 'critical' },
    ],
    weight: 1.3,
  },
