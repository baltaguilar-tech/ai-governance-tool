...
export const ACHIEVER_QUESTIONS: AssessmentQuestion[] = [
  ...
  },
  {
    ...
    dimension: 'aiSpecificRisks',
    jurisdictions: ['eu'],
    text: 'How is EU AI Act Annex III classification integrated into your AI procurement, development, and deployment governance processes?',
    helpText: 'At the Achiever level, Annex III classification is not a one-time review — it is embedded in every AI approval gate. New systems, vendor contracts, and use case expansions should automatically trigger classification review before deployment.',
    type: 'radio',
    options: [
      { label: 'No Annex III classification process in place', value: 100, riskLevel: 'critical' },
      { label: 'Classification reviewed on an ad hoc basis when specifically prompted', value: 75, riskLevel: 'high' },
      { label: 'Classification documented for current AI systems but not yet embedded in procurement or development gates', value: 50, riskLevel: 'high' },
      { label: 'Annex III classification integrated into AI procurement and development approval; documented per system with assigned owners and review cadence', value: 25, riskLevel: 'medium' },
      { label: 'Annex III classification is a mandatory, auditable gate in all AI procurement, development, and use case expansion workflows; maintained continuously; reported to the AI governance committee', value: 0, riskLevel: 'low' },
    ],
    weight: 1.3,
  },
  {
    ...
    dimension: 'aiSpecificRisks',
    jurisdictions: ['eu'],
    text: 'Are conformity assessments for high-risk AI systems complete, current, independently reviewed, and audit-ready on demand?',
    helpText: 'The EU AI Act requires conformity assessments before market placement and ongoing maintenance. At the Achiever level, conformity documentation must be audit-ready at all times — not assembled reactively when a regulator requests it.',
    type: 'radio',
    options: [
      { label: 'No conformity assessments completed for high-risk AI systems', value: 100, riskLevel: 'critical' },
      { label: 'Conformity assessments initiated but incomplete or not independently reviewed', value: 75, riskLevel: 'high' },
      { label: 'Conformity assessments complete for primary high-risk systems; not yet on a defined review schedule', value: 50, riskLevel: 'high' },
      { label: 'Conformity assessments complete, documented, and independently reviewed; reviewed on a defined schedule', value: 25, riskLevel: 'medium' },
      { label: 'Conformity assessments for all high-risk AI systems are complete, independently reviewed, maintained on a regulatory-grade schedule, and retrievable on demand from a centralised AI compliance register', value: 0, riskLevel: 'low' },
    ],
    weight: 1.4,
  },
  {
    ...
    dimension: 'aiSpecificRisks',
    jurisdictions: ['eu'],
    text: 'Are human oversight, override, and escalation procedures for high-risk AI systems tested, logged, and available to regulators on demand?',
    helpText: 'EU AI Act Article 14 requires high-risk AI systems to be designed for meaningful human intervention. At the Achiever level, oversight is not just documented — it is operationally tested, logged, and independently auditable to demonstrate regulatory compliance.',
    type: 'radio',
    options: [
      { label: 'No documented human oversight or override procedures for high-risk AI systems', value: 100, riskLevel: 'critical' },
      { label: 'Oversight procedures documented but not operationally tested or logged', value: 75, riskLevel: 'high' },
      { label: 'Oversight procedures documented and operational; testing not on a defined schedule; logs not centralised', value: 50, riskLevel: 'high' },
      { label: 'Oversight procedures documented, tested, and logged; not yet integrated into AI governance committee reporting', value: 25, riskLevel: 'medium' },
      { label: 'Human oversight, override, and escalation procedures for high-risk AI are formally documented per system, operationally enforced, tested on a defined schedule, centrally logged, reported to the AI governance committee, and retrievable for regulatory inspection on demand', value: 0, riskLevel: 'low' },
    ],
    weight: 1.4,
  },
